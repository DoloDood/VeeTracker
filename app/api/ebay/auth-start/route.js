...
// value carries their user id (and chosen environment) through the
...
export async function GET(req) {
  ...
  await sql`INSERT INTO ebay_oauth_state (state, user_id, environment) VALUES (${state}, ${user.id}, ${env})`;
